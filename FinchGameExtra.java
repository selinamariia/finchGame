...
public class FinchGameExtra 
{
	...
	switchFinch.saySomething("how many players?");
	int playerNum = playerInfo.nextInt();
	switchFinch.saySomething("input player names");
	 ...
	 * is off
	 */
	while(switchFinch.isFinchUpsideDown()==false)
	{
		/**
		 ...
		 */
			while(lives>0)
			{
				...
				for(int i = 0; i <rounds; i++)
				{
					...
					readFinchArray(yellowFinch, redFinch, greenFinch, blueFinch, listNum);
				}
				...
				for(int countNumb = (playerNum-1); countNumb>=0; countNumb--)
				{
					...
					{
						userList.add(checkUserInput(yellowFinch, redFinch, greenFinch, blueFinch, finchTapped));
					}
			...
			switchFinch.saySomething("game over. Your score is " + (rounds - 3));
			switchFinch.sleep(3000);
	 ...
	 * @param index
	 */
	public static void readFinchArray (Finch yellowFinch, Finch redFinch, Finch greenFinch, Finch blueFinch, int listNum)
	{
	 ...
	 * @return
	 */
	public static int checkUserInput(Finch yellowFinch, Finch redFinch, Finch greenFinch, Finch blueFinch, int finchTapped)
	{
		int isTapped = 0;
